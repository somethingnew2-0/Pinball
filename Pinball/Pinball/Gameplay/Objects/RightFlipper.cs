...
namespace Pinball
{
    public class RightFlipper : GameObject
    {
        ...
        {
            base.Body = BodyFactory.CreateBody(physicsSimulator, position);

            // Flipper Fixture
            base.Fixtures.AddLast(FixtureFactory.CreateRectangle(15, 51, 10, base.Body, -(new Vector2(11, -11))));
            //physicsSimulator, base.Body, 15, 51, Vector2.Zero, MathHelper.ToRadians(40f), 0.5f);
        ...
        private List<Vertices> CreateRightFlipper()
        {
