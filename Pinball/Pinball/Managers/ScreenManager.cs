...
namespace Pinball
{
    ...
    public class ScreenManager : DrawableGameComponent
    {
        ...
        /// <summary>
        /// The logo texture for the game draw next to
        /// selected menu items and in the loading screen.
        /// </summary>
        ...
        {
            get { return base.GraphicsDevice.Viewport.Width; }
        }

        public int ScreenHeight
        {
            get { return base.GraphicsDevice.Viewport.Height; }
        }
        ...
        protected override void LoadContent()
        {
            ...
            blankTexture = content.Load<Texture2D>(@"MenuTextures\Blank");
            logoTexture = content.Load<Texture2D>(@"MenuTextures\Logo");
