    ...
    class LoadingScreen : GameScreen
    {
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            if (loadingIsSlow)
            {
                ...
                Vector2 textPosition = new Vector2((viewportSize.X - textSize.X) / 2, ((viewportSize.Y - textSize.Y) / 2) - 30);
                ...
                int dotCount = (int)(loadAnimationTimer.TotalSeconds * 2) % 5;
                ...
                int xPosition = 77;
                for (int counter = 0; counter < dotCount; counter++)
			    {
			        spriteBatch.Draw(logo, new Vector2(xPosition,
                        (viewportSize.Y / 2)), null, color, 0f,
