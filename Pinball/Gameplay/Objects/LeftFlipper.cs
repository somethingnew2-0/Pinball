...
namespace Pinball
{
    public class LeftFlipper : GameObject
    {
        ...
        {
            //base.Body = BodyFactory.Instance.CreatePolygonBody(physicsSimulator, CreateLeftFlipper(), 100000f);
        ...
        public static void LoadContent(ContentManager contentManager)
        {
            ...
            //secondtexture = contentManager.Load<Texture2D>(@"GameTextures\LeftFlipperHit");
        }
        ...
        public void HandleInput(bool leftHit)
        {
            if (leftHit)
            {
                ...
                //fixedAngleSpring.TargetAngle = (3 * MathHelper.PiOver2);
        ...
        private Vertices CreateLeftFlipper()
        {
